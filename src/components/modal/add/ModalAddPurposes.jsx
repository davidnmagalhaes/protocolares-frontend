...
import { Actions } from './ModalAddPurposesStyle';
import { makeStyles } from '@material-ui/core/styles';
import { Context } from '../../../services/context';

const ModalAddPurposes = ({ params }) => {
      ...
      {!open ? (
        ...
        >
          <DialogTitle id="alert-dialog-title">
            {'Cadastro de Finalidades de Uso'}
          </DialogTitle>
          <DialogContent>
...
export default ModalAddPurposes;
